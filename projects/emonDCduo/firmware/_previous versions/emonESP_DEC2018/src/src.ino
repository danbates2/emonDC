...
const int main_interval = 3000; // milliseconds interval for averaging samples and sending to emonCMS.

int ADC_DelayTest = 0; //microsecond delay in ADC routine, to improve accuracy,
