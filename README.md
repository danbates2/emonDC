...
###### Project status: Reviewing Documentation. Develoment Units not available.
...
- Two-channel high **only** DC current and voltage sensing, up to 64.4V or 75V, suitable for a wide range of low-voltage generator/battery systems.
