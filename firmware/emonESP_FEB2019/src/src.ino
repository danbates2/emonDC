...
const int main_interval = 5000; // milliseconds interval for averaging samples and sending to emonCMS.

int ADC_DelayTest = 2; //microsecond delay in ADC routine, to improve accuracy,
...
void loop()
{
  ...
  if (currentMillis - previousMillis >= main_interval) { // Averaging and print loop.
    Serial.print("Micros: ");
