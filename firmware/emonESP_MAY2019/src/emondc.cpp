...
unsigned long main_emondc_interval = 10; // seconds
...
int ADC_DelayTest = 0; // microsecond delay in ADC routine, to improve accuracy, related to the Sample and Hold architecture of the ADC.
