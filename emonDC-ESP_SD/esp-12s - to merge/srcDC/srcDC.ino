/*
   ...
   Additional code for downloading from SD card taken 
   from sparkfun SD.h and associated libraries, 
   merged by Daniel Bates.
   -------------------------------------------------------------------
...
// String datalogfilename = "test";
// DEBUG.println(datalogfilename);
} // end loop
